...
export default function ResetPasswordPage() {
  ...
  useEffect(() => {
    ...
    // onAuthStateChange fires PASSWORD_RECOVERY when Supabase detects that event.
    ...
    // If the session is already established (page was refreshed after callback),
    // getSession will have a valid user — show the form directly.
